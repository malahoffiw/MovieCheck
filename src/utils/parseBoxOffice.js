const parseBoxOffice = (dataBoxOffice) => {
    ...
    const budget = budgetInfo
        ? budgetInfo.amount.toLocaleString('ru-RU', { style: 'currency', currency: budgetInfo.currencyCode})
        : ""
    const world = worldInfo
        ? worldInfo.amount.toLocaleString('ru-RU', { style: 'currency', currency: worldInfo.currencyCode})
        : ""
